...
user_1 = User.create(first_name: 'John', last_name: 'Smith', username: 'johnsmith', email: 'john.smith@gmail.com', password: 'password', bio: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pulvinar dictum hendrerit. Cras efficitur ligula sed euismod dapibus. Pellentesque a nunc id nibh posuere varius id eget nibh. Nulla sed fermentum lectus. Pellentesque vitae nunc sollicitudin, ornare dolor ac, laoreet tortor.', created_at: Time.now, last_sign_in_at: Time.now, is_artist: false)
user_2 = User.create(first_name: 'Bruce', last_name: 'Wayne', username: 'brucewayne', email: 'bruce.wayne@gmail.com', password: 'password', bio: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pulvinar dictum hendrerit. Cras efficitur ligula sed euismod dapibus. Pellentesque a nunc id nibh posuere varius id eget nibh. Nulla sed fermentum lectus. Pellentesque vitae nunc sollicitudin, ornare dolor ac, laoreet tortor.', created_at: Time.now, last_sign_in_at: Time.now, is_artist: true)
user_3 = User.create(first_name: 'Johnny', last_name: 'Appleseed', username: 'johnnyappleseed', email: 'johnny.appleseed@gmail.com', password: 'password', bio: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pulvinar dictum hendrerit. Cras efficitur ligula sed euismod dapibus. Pellentesque a nunc id nibh posuere varius id eget nibh. Nulla sed fermentum lectus. Pellentesque vitae nunc sollicitudin, ornare dolor ac, laoreet tortor.', created_at: Time.now, last_sign_in_at: Time.now, is_artist: false)
user_4 = User.create(first_name: 'Sarah', last_name: 'Jackson', username: 'sarahjackson', email: 'sarah.jackson@gmail.com', password: 'password', bio: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pulvinar dictum hendrerit. Cras efficitur ligula sed euismod dapibus. Pellentesque a nunc id nibh posuere varius id eget nibh. Nulla sed fermentum lectus. Pellentesque vitae nunc sollicitudin, ornare dolor ac, laoreet tortor.', created_at: Time.now, last_sign_in_at: Time.now, is_artist: true)

# ARTWORKS

artwork_1 = Artwork.create(
  title: 'Lorem ipsum', description: 'In ultricies commodo elementum. Pellentesque id efficitur libero. Phasellus fringilla metus eget lorem molestie, vitae hendrerit purus lacinia. Sed euismod lorem quis erat faucibus faucibus. Donec et faucibus libero. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aliquam erat volutpat. Phasellus quis pharetra velit. ', user_id: user_2.id, lat: 51.50025191145822, lng: -0.10413105273437395, address: '21 Main Street, Hackney, London E2 2FJ, UK', image: 'https://s3-eu-west-1.amazonaws.com/grafff/getxophoto_showcase-550x365.jpg', created_at: Faker::Time.between(5.days.ago, Time.now, :day))
artwork_2 = Artwork.create(title: 'Dolor sit', description: 'In ultricies commodo elementum. Pellentesque id efficitur libero. Phasellus fringilla metus eget lorem molestie, vitae hendrerit purus lacinia. Sed euismod lorem quis erat faucibus faucibus. Donec et faucibus libero. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aliquam erat volutpat. Phasellus quis pharetra velit. ', user_id: user_2.id, lat: 51.493839792696555, lng: -0.13091022753906145, address: '21 Main Street, Hackney, London E2 2FJ, UK', image: 'https://s3-eu-west-1.amazonaws.com/grafff/getxophoto_showcase-550x365.jpg', created_at: Faker::Time.between(5.days.ago, Time.now, :day))
artwork_3 = Artwork.create(title: 'Amet consectectur', description: 'In ultricies commodo elementum. Pellentesque id efficitur libero. Phasellus fringilla metus eget lorem molestie, vitae hendrerit purus lacinia. Sed euismod lorem quis erat faucibus faucibus. Donec et faucibus libero. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aliquam erat volutpat. Phasellus quis pharetra velit. ', user_id: user_4.id, lat: 51.505380957008015, lng: -0.09932453417968645, address: '21 Main Street, Hackney, London E2 2FJ, UK', image: 'https://s3-eu-west-1.amazonaws.com/grafff/getxophoto_showcase-550x365.jpg', created_at: Faker::Time.between(5.days.ago, Time.now, :day))
artwork_4 = Artwork.create(title: 'Lorem ipsum dolor', description: 'In ultricies commodo elementum. Pellentesque id efficitur libero. Phasellus fringilla metus eget lorem molestie, vitae hendrerit purus lacinia. Sed euismod lorem quis erat faucibus faucibus. Donec et faucibus libero. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aliquam erat volutpat. Phasellus quis pharetra velit. ', user_id: user_4.id, lat: 51.51734648505407, lng: -0.11237079882812395, address: '21 Main Street, Hackney, London E2 2FJ, UK', image: 'https://s3-eu-west-1.amazonaws.com/grafff/getxophoto_showcase-550x365.jpg', created_at: Faker::Time.between(5.days.ago, Time.now, :day))
artwork_5 = Artwork.create(title: 'Ipsum sit amet', description: 'In ultricies commodo elementum. Pellentesque id efficitur libero. Phasellus fringilla metus eget lorem molestie, vitae hendrerit purus lacinia. Sed euismod lorem quis erat faucibus faucibus. Donec et faucibus libero. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aliquam erat volutpat. Phasellus quis pharetra velit. ', user_id: user_2.id, lat: 51.50067935396985, lng: -0.08627826953124895, address: '21 Main Street, Hackney, London E2 2FJ, UK', image: 'https://s3-eu-west-1.amazonaws.com/grafff/getxophoto_showcase-550x365.jpg', created_at: Faker::Time.between(5.days.ago, Time.now, :day))
artwork_6 = Artwork.create(title: 'Test artwork', description: 'In ultricies commodo elementum. Pellentesque id efficitur libero. Phasellus fringilla metus eget lorem molestie, vitae hendrerit purus lacinia. Sed euismod lorem quis erat faucibus faucibus. Donec et faucibus libero. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aliquam erat volutpat. Phasellus quis pharetra velit. ', user_id: user_4.id, lat: 51.51734648505407, lng: -0.08627826953124895, address: '21 Main Street, Hackney, London E2 2FJ, UK', image: 'https://s3-eu-west-1.amazonaws.com/grafff/getxophoto_showcase-550x365.jpg', created_at: Faker::Time.between(5.days.ago, Time.now, :day))
artwork_7 = Artwork.create(title: 'Awesome sprayz', description: 'In ultricies commodo elementum. Pellentesque id efficitur libero. Phasellus fringilla metus eget lorem molestie, vitae hendrerit purus lacinia. Sed euismod lorem quis erat faucibus faucibus. Donec et faucibus libero. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aliquam erat volutpat. Phasellus quis pharetra velit. ', user_id: user_4.id, lat: 51.51435539767495, lng: -0.09451801562499895, address: '21 Main Street, Hackney, London E2 2FJ, UK', image: 'https://s3-eu-west-1.amazonaws.com/grafff/getxophoto_showcase-550x365.jpg', created_at: Faker::Time.between(5.days.ago, Time.now, :day))
