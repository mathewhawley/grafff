...
artwork_1 = Artwork.create(
  ...
  created_at: Faker::Time.between(96.days.ago, Time.now, :day))
...
# Artist 1
Relationship.create(follower_id: user_1.id, followed_id: artist_1.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_2.id, followed_id: artist_1.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_3.id, followed_id: artist_1.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_4.id, followed_id: artist_1.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_5.id, followed_id: artist_1.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))

# Artist 2
Relationship.create(follower_id: user_6.id, followed_id: artist_2.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_7.id, followed_id: artist_2.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_8.id, followed_id: artist_2.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_9.id, followed_id: artist_2.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_10.id, followed_id: artist_2.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_11.id, followed_id: artist_2.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_12.id, followed_id: artist_2.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_13.id, followed_id: artist_2.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_14.id, followed_id: artist_2.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_15.id, followed_id: artist_2.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_16.id, followed_id: artist_2.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))

# Artist 3
Relationship.create(follower_id: user_17.id, followed_id: artist_3.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_1.id, followed_id: artist_3.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_2.id, followed_id: artist_3.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_3.id, followed_id: artist_3.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_4.id, followed_id: artist_3.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_5.id, followed_id: artist_3.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_6.id, followed_id: artist_3.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_7.id, followed_id: artist_3.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))

# Artist 4
Relationship.create(follower_id: user_8.id, followed_id: artist_4.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_9.id, followed_id: artist_4.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_10.id, followed_id: artist_4.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_11.id, followed_id: artist_4.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_12.id, followed_id: artist_4.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_13.id, followed_id: artist_4.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_14.id, followed_id: artist_4.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_15.id, followed_id: artist_4.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_16.id, followed_id: artist_4.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_17.id, followed_id: artist_4.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_1.id, followed_id: artist_4.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_2.id, followed_id: artist_4.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_3.id, followed_id: artist_4.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_4.id, followed_id: artist_4.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))

# Artist 5
Relationship.create(follower_id: user_5.id, followed_id: artist_5.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_6.id, followed_id: artist_5.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_7.id, followed_id: artist_5.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_8.id, followed_id: artist_5.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_9.id, followed_id: artist_5.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_10.id, followed_id: artist_5.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_11.id, followed_id: artist_5.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_12.id, followed_id: artist_5.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_13.id, followed_id: artist_5.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_14.id, followed_id: artist_5.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))

# Artist 6
Relationship.create(follower_id: user_15.id, followed_id: artist_6.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_16.id, followed_id: artist_6.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_17.id, followed_id: artist_6.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))

# Artist 7
Relationship.create(follower_id: user_1.id, followed_id: artist_7.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_2.id, followed_id: artist_7.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_3.id, followed_id: artist_7.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_4.id, followed_id: artist_7.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_5.id, followed_id: artist_7.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_6.id, followed_id: artist_7.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_7.id, followed_id: artist_7.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_8.id, followed_id: artist_7.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_9.id, followed_id: artist_7.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_10.id, followed_id: artist_7.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_11.id, followed_id: artist_7.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_12.id, followed_id: artist_7.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_13.id, followed_id: artist_7.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_14.id, followed_id: artist_7.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_15.id, followed_id: artist_7.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_16.id, followed_id: artist_7.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_17.id, followed_id: artist_7.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))

# Artist 8
Relationship.create(follower_id: user_11.id, followed_id: artist_8.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_12.id, followed_id: artist_8.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_13.id, followed_id: artist_8.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_14.id, followed_id: artist_8.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_15.id, followed_id: artist_8.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_16.id, followed_id: artist_8.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_17.id, followed_id: artist_8.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))
Relationship.create(follower_id: user_3.id, followed_id: artist_8.id, created_at: Faker::Time.between(96.days.ago, Time.now, :day))